...
xst -ifn xst.scr
move adc_clk_gen_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\adc_clk_gen_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc adc_clk_gen_exdes.ucf adc_clk_gen_exdes

echo 'Running map'
map -timing -pr b adc_clk_gen_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm adc_clk_gen_exdes -w routed.ncd routed.v
cd ..
